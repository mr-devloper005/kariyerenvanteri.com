...
export const taskPageVoices = {
  ...
  pdf: {
    eyebrow: 'Guides',
    headline: 'Guides arranged for quick reading and clean downloads.',
    description: 'Guide pages should feel like useful reports and reference material instead of normal articles.',
